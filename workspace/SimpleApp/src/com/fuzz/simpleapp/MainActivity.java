...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    public static class SectionFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            switch(tabType) {
            case ALL_ITEMS:            	
            	// Get the size of textList and imageHM to create a list
            	// long enough to hold both.  
            	int textSize = ((MainActivity)thisMain).textList.size();            	
            	int size = textSize + ((MainActivity)thisMain).imageHM.size();
            	// Create list with AllDataIndex which hold info on whether to
            	// display text or image.  Then pass to adapter.
            ...
            case TEXT_ONLY:
                ...
                // Create list the size of the textList to pass to Adapter
            ...
            case IMAGE_ONLY: 
                ...
                // Create list the size of imageHM to pass into the adapter
                for (int i= 0; i < ids.length; i++){
                    ids[i] = "";
                }
	...
	private void getData() {
    	...
    	// Get text list after data read using URL
	...
	/**
	 * Read JSON data using URL in separate thread.
	 *
	 */
    class GetSampleData extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
		    ...
		    JSONObject json = jsonParser.makeHttpRequest(URL_DATA, "GET",
		            params);
        ...
        // Populate the images with the bitmap data
    ...
    /*
     * Get the image as a bitmap using a URL in a separate thread.
     */
    private class DownloadImageTask extends AsyncTask<String, Void, Bitmap> {
        ...
        public DownloadImageTask(Hashtable<Integer, Bitmap> imageHM_in, Integer intKey_in) { // ImageView bmImage) {
        	// Hash Map to store image
        	this.imageHM = imageHM_in;
        	// Key to use with Hash Map
            this.intKey = intKey_in;
        }

        // Get bitmap using URL passed when calling AsyncTask.excute(url).
    ...
    /*
     * Store data type (text or image) and index
     */
    class AllDataIndex {
